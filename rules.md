...
- [x] Canvas-based survival shooter scaffold
- [x] Reusable FSM module
- [x] 5+ AI states
- [x] 10+ implemented events
- [x] Main menu, pause, and game over overlays
- [x] HUD and weapon switching
- [x] Generated sound effects and music with mute
- [x] FSM documentation files
- [ ] GitHub Pages deployment
- [ ] Final gameplay screenshot or GIF capture
